...
from proposal_terms import DEFAULT_PROPOSAL_TERMS


# ─── Terms & Conditions (Standard Interiors 5/16/2023) ───────────────────────
# The editor's default Terms list is exactly what the customer PDF prints:
# the preamble, then clauses 1-16 (see proposal_terms).
PROPOSAL_TERMS: list[str] = list(DEFAULT_PROPOSAL_TERMS)
