...
SUNDRY_RULES: dict[str, list[dict]] = {
    "unit_carpet_no_pattern": [
        ...
        {"sundry_name": "pad_cement", "coverage": 100, "unit": "SY/each", "unit_price": 29.16},
        {"sundry_name": "tack_strip", "coverage": 400, "unit": "LF/carton", "unit_price": 36.39,
         "qty_source": "tack_strip_lf", "notes": "RFMS measured LF / 400 LF per carton. Concrete tack strip."},
        {"sundry_name": "seam_tape", "coverage": 60, "unit": "LF/roll", "unit_price": 9.54,
    ...
    "unit_lvt": [
        ...
        {"sundry_name": "primer", "coverage": 350, "unit": "SF/bucket", "unit_price": 15.94,
    ...
    "floor_tile": [
        ...
        {"sundry_name": "grout", "coverage": 100, "unit": "SF/bag", "unit_price": 32.91,
         "qty_basis": "grout_formula", "joint_width": 0.1875,
         "notes": "Prism 17lb bag ($32.58 base + $0.33 freight). Coverage from tile dims + 3/16 joint. Formula: 2.73*(W*L)/((W+L)*J*T)"},
    ],
    "wall_tile": [
        {"sundry_name": "thinset", "coverage": 40, "unit": "SF/bag", "unit_price": 15.95,
         "white_price": 17.95, "skip_if_lft": True, "notes": "grey $15.95, white $17.95 for mosaic/backsplash. Skipped for large format tiles."},
    ...
    "backsplash": [
        ...
        {"sundry_name": "grout", "coverage": 100, "unit": "SF/bag", "unit_price": 32.91,
         "qty_basis": "grout_formula", "joint_width": 0.1875,
         "notes": "Prism 17lb bag ($32.58 base + $0.33 freight). Coverage from tile dims + 3/16 joint. Formula: 2.73*(W*L)/((W+L)*J*T)"},
        {"sundry_name": "caulking", "coverage": 2, "unit": "units/tube", "unit_price": 13.41,
    ...
    "rubber_base": [
        {"sundry_name": "adhesive", "coverage": 60, "unit": "LF/tube", "unit_price": 4.38,
         "notes": "Cove base adhesive, 60 LF/tube coverage"},
    ],
    "rubber_tile": [
...
STAIR_SUNDRY_KITS: dict[str, list[dict]] = {
    "stretched": [
        ...
        {"sundry_name": "Stair Tack Strip", "ratio_per_stair": 6.0, "unit": "LF/carton", "unit_price": 50.00, "carton_size": 400,
         "notes": "Gypcrete tack strip $50.00/carton, 400 LF/carton, round up to full box. Stairs are on elevated (gypcrete) floors."},
        {"sundry_name": "Stair Seam Sealer", "ratio_per_stair": 5.307, "unit": "LF", "unit_price": 0.1590,
         "notes": "$9.54/roll ÷ 60 LF/roll = $0.1590/LF"},
    ],
}
